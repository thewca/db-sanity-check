...
insert into sanity_checks (id, sanity_check_category_id, topic, query) values (2, 1, 'Exclusion', 'SELECT * FROM Persons WHERE (name LIKE \'%(%\' OR name LIKE \'%)\') AND name NOT LIKE \'%(%)%\'');

-- Exclusion (generated by the process)
INSERT INTO sanity_check_exclusions (sanity_check_id, exclusion, comments) values (2, '{"subId":"2","comments":"","gender":"f","month":"12","year":"1954","name":"Dottie (mcDonald","incorrect_wca_id_claim_count":"0","id":"1982FRID01","day":"4","countryId":"Czech Republic","rails_id":"5"}', '');
...
INSERT INTO wca_development.Persons (id, subId, name, countryId, gender, `year`, `month`, `day`, comments, rails_id, incorrect_wca_id_claim_count) VALUES('1982FRID01', 2, 'Dottie (mcDonald', 'Czech Republic', 'f', 1954, 12, 4, '', 5, 0);
