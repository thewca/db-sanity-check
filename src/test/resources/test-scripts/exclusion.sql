...
-- Exclusion generated by a run and checking exclusion service
-- 1. [Person Data Irregularities] Names with numbers
INSERT INTO sanity_check_exclusions (sanity_check_id, exclusion, comments) values (1, '{"subId":"2","comments":"","gender":"f","month":"12","year":"1954","name":"Dottie Marsh 2","incorrect_wca_id_claim_count":"0","id":"1982FRID01","day":"4","countryId":"Czech Republic","rails_id":"5"}', '');
