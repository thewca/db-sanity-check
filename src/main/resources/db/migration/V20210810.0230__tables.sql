...
CREATE TABLE `registration_payments` (
  ...
  `receipt_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `stripe_payment_intents` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `holder_type` varchar(191) DEFAULT NULL,
  ...
  `confirmed_by_type` varchar(191) DEFAULT NULL,
  `confirmed_by_id` bigint DEFAULT NULL,
  `canceled_at` datetime(6) DEFAULT NULL,
  `canceled_by_type` varchar(191) DEFAULT NULL,
...
CREATE TABLE `stripe_transactions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `api_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `index_stripe_transactions_on_parent_transaction_id` (`parent_transaction_id`),
